...
PARAM = 'param={"pageIndex":%s,"pageSize":1,"filterItems":{"st3":[{"cmd":"pg_cate_brand_model=%s","style":"326"}]},"secondFrom":"","initFrom":"2_1_14275_0","channelPageName":"iPhone","tab":0,"rstmark":1671608495247,"labelIdList":""}'
...
class ZhuanzhuanSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        model = "iPhone 14"
        model_value = "101,10530,95637"
        yield scrapy.Request(self.start_url,
                             method="POST",
                             body=PARAM % (1, "101,10530,95637"),
